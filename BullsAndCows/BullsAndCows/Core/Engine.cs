...
namespace BullsAndCows.Core
{
    public class Engine
    {
        ...
        private void StartGame()
        {
            while (true)
            {
                Console.Write(string.Format(GlobalConstants.MakeAGuess, this.firstPlayer.Name));
                ...
                Console.Write(string.Format(GlobalConstants.MakeAGuess, this.secondPlayer.Name));
        ...
        private void ValidatePlayers()
        {
            ...
            Console.Write(string.Format(GlobalConstants.PlayerNumber, firstPlayerName));
            ...
            Console.Write(string.Format(GlobalConstants.PlayerNumber, secondPlayerName));
            Console.ForegroundColor = ConsoleColor.White;
        ...
        private static int TryParseNumberInput(string input)
        {
            ...
            if (result.ToString().Length != NumberLength)
            {
